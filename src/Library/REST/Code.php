...
class REST_Code
{
    ...
    const STATUS_ERROR_INSERT_FAILED = 913; //数据库操作失败
    ...
    const STATUS_ERROR_PARAMS_EMPTY     = 933; //参数为空
    const STATUS_ERROR_PARAMS_DUPLICATE = 934; //用户数据重复
    ...
    protected static $status_msgs = array(
        ...
        self::STATUS_ERROR_INSERT_FAILED          => '数据库操作失败',
        ...
        self::STATUS_ERROR_PARAMS_EMPTY           => '参数为空',
        self::STATUS_ERROR_PARAMS_DUPLICATE       => '用户数据重复',
